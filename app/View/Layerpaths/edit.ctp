...
<?php echo $this->Form->create('Layerpath'); ?>
	<fieldset>
		<legend><?php echo __('Edit Layerpath'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Layerpath.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Layerpath.id'))); ?></li>
