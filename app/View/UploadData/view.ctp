...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Upload Data'), array('action' => 'edit', $uploadData['UploadData']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Upload Data'), array('action' => 'delete', $uploadData['UploadData']['id']), array(), __('Are you sure you want to delete # %s?', $uploadData['UploadData']['id'])); ?> </li>
